    ...
    **space_objects** — список объектов планет и звёзд
    ...
    with open(output_filename, 'w') as out_file:
        for obj in space_objects:
            print(out_file, obj.type + " %d " % obj.R + obj.color + " %f %f %f %f %f" % (obj.m, obj.x, obj.y, obj.Vx, obj.Vy))
            out_file.write(obj.type + " %d " % obj.R + obj.color + " %f %f %f %f %f" % (obj.m, obj.x, obj.y, obj.Vx, obj.Vy) + '\n')
